...
const isInCart = cartIds.includes(product._id?.toString());
      ...
      <div className="p-4 space-y-2 flex flex-col">
        ...
        <div className="flex justify-end mt-4">
         ...
         ❌ Remove From Cart
          ...
          <button
                      className="px-4 py-1.5 text-sm font-medium text-green-600 border border-red-200 rounded-full hover:bg-green-500 hover:text-white transition" 
